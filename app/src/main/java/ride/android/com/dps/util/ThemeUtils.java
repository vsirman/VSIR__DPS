package ride.android.com.dps.util;
...
public class ThemeUtils {
    ...
    public void updateTheme(){
        this.primaryColor = (int) SharedPreferencesUtils.getParam(context,context.getString(R.string.preference_primary_color),
                getColor(R.color.colorPrimary));
        this.primaryDarkColor = (int) SharedPreferencesUtils.getParam(context,context.getString(R.string.primary_darkcolor),
                getColor(R.color.colorPrimaryDark));
        this.accentColor = (int) SharedPreferencesUtils.getParam(context,context.getString(R.string.preference_accent_color),
                getColor(R.color.colorPrimaryDark));
        baseTheme = (int) SharedPreferencesUtils.getParam(context,context.getString(R.string.preference_base_theme), LIGHT_THEME);
    }
    ...
    public static int getPrimaryColor(Context context) {
        return (int) SharedPreferencesUtils.getParam(context,context.getString(R.string.preference_primary_color),
    ...
    public static int getAccentColor(Context context) {
        return (int) SharedPreferencesUtils.getParam(context,context.getString(R.string.preference_accent_color),
                getColor(context, R.color.colorPrimary));
    }

    public static int getBaseTheme(Context context) {
        return (int) SharedPreferencesUtils.getParam(context,context.getString(R.string.preference_base_theme), LIGHT_THEME);
    ...
    public void updateSwitchColor(SwitchCompat sw, int color){
        if (sw.isChecked()) sw.getThumbDrawable().setColorFilter(color, PorterDuff.Mode.MULTIPLY);
        else sw.getThumbDrawable().setColorFilter(getSubTextColor(), PorterDuff.Mode.MULTIPLY);
        if (sw.isChecked())
            sw.getTrackDrawable().setColorFilter(ColorPaletteUtils.getTransparentColor(color, 100), PorterDuff.Mode.MULTIPLY);
        else sw.getTrackDrawable().setColorFilter(getBackgroundColor(), PorterDuff.Mode.MULTIPLY);
    }
