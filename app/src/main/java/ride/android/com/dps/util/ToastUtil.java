...
public class ToastUtil {
	...
	public static void show(Context context, String info) {
        Toasty.error(context, info, Toast.LENGTH_LONG,true).show();
	}
	...
	public static void showerror(Context context, int rCode){
		try {
            ...
            case 1802:
            	throw new AMapException("连接失败,请检查网络状况是否良好");
            case 1803:
            	throw new AMapException(AMapException.AMAP_CLIENT_URL_EXCEPTION);
            case 1804:
            	throw new AMapException("未知主机," + "请检查网络连接是否畅通");
            case 1806:
            	throw new AMapException("连接失败,请检查网络状况以及网络的稳定性");
            case 1900:
	        ...
	        default:
	        	Toasty.error(context,"查询失败："+rCode , Toast.LENGTH_LONG).show();
				break;
	        }
        } catch (Exception e) {
